...
--
-- Table structure for table `tp_season`
--

DROP TABLE IF EXISTS `tp_season`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_season` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKdi7syfymup8ta779j7h9ewpme` (`user_id`),
  CONSTRAINT `FKdi7syfymup8ta779j7h9ewpme` FOREIGN KEY (`user_id`) REFERENCES `tp_user` (`id`) ON DELETE CASCADE
